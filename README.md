...
Forest Carbon Lite V.1.0 - A comprehensive Python implementation of a "FullCAM-lite" forest carbon accounting model, featuring the Tree Yield Formula (TYF) growth engine with dynamic scenario generation and climate change integration.
...
python main.py simulate --forest EOF --years 30 --config custom_config.yaml --climate paris --seed 456
```
...
python main.py analyze --forest-types ETOF --climates current,plus2 --managements m,i --workers 8 --plots --uncertainty --seed 123
...
python custom_afm_simulator.py --forest-type AFW --management i --years 25
python custom_afm_simulator.py --forest-type EOF --management m --years 30
