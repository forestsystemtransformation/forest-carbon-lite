...
class AFMOnlySimulator(ForestCarbonSimulator):
    ...
    def _plot_afm_additionality(self, plotter, results: Dict, forest_types: List[str]):
        ...
        plotter._save_figure('additionality', formats=['png'])
...
def main():
    ...
    parser.add_argument('--site', default='ETOF', help='Site/forest type (default: ETOF)')
    ...
    if args.output_dir is None:
        args.output_dir = f'output/{args.site}_{args.climate}_{args.management}_afm_only'
    
    print(f"🌲 AFM vs Degrading Analysis")
    print(f"Forest Type: {args.site}")
